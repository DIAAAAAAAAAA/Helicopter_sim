function [dx,y] = state_space_function(t,x,u,Iyy,K_pitch,m_heli,L_heli,L_cw,varargin)
...
% Equation of motion
% pitch DOF
d_theta_dot = (K_pitch*u(1)/Iyy) - (m_heli/Iyy)*g*L_heli*cos(theta) - (m_cw/Iyy)*g*L_cw *sin(theta);
