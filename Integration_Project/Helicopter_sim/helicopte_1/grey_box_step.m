...
p_init = [ 0.039857 , 0.795216, 0.0039208,-0.00916309, 0.000697728, 0.0327237, 0.000680719, 0.0148128 , 4.12861, 0.0845429]; % Iyy,m_heli, C_pitch,T_bias,c, Km, J ,L , R,C_T
...
nl_sys.Parameters(8).Fixed = true;  % fix 
nl_sys.Parameters(9).Fixed = true;  % fix 
...
nl_sys.InitialStates(2).Fixed = true; % theta_dot_0
nl_sys.InitialStates(2).Value = 0;     % Initial theta 

nl_sys.InitialStates(3).Fixed = true; % I
nl_sys.InitialStates(3).Value = 0; % initial current

nl_sys.InitialStates(4).Fixed = true; % w
nl_sys.InitialStates(4).Value = 0;     % Initial angular speed
